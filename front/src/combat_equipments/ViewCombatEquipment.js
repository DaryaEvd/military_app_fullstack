                        ...
                        <div className="card-header">
                            ...
                            <ul className="list-group list-group-flush">
                                <li className="list-group-item">
                                    <b>Name:</b>
                                    {combatEquipments.nameOfEquipment}
                                </li>
                                <li className="list-group-item">
                                    <b>Experience of using:</b>
                                    {combatEquipments.experienceOfUsing}
                                </li>
                                <li className="list-group-item">
                                    <b>Condition of vehicle:</b>
                                    {combatEquipments.conditionOfVehicle}
                                </li>
                                <li className="list-group-item">
                                    <b>Number of seats:</b>
                                    {combatEquipments.numberOfSeats}
                                </li>
                                <li className="list-group-item">
                                    <b>Name of vehicle:</b>
                                    {combatEquipments.nameOfVehicle}
                                </li>
                            </ul>
                        </div>
                    </div>
