...
export default function EditMilitaryBuilding() {
    ...
    const fetchSubdivisions = async () => {
        try {
            ...
            console.error("Error fetching military buildings:", error);
        }
    };
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`http://localhost:8080/api/military_building/${id}`, militaryBuilding);
            navigate("/military_building");
        } catch (error) {
            console.error("Error updating military building:", error);
        }
    };
        ...
        <div className='container'>
            <div className='row'>
                <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
                    <h2 className='text-center m-4'>Edit Military Building</h2>
